...
class PathUtils {
    ...
    static void drawCircle(Canvas canvas, Paint paint, float x, float y, float radius) {
     ...
     */
    static void drawVerticalLine(Canvas canvas, Paint paint, float x, float y, double length) {
     ...
     */
    static void drawHorizontalLine(Canvas canvas, Paint paint, float x, float y, double length) {
     ...
     */
    static void drawCrossMark(Canvas canvas, Paint paint, float x, float y, double length) {
    ...
    static Path createLine(float x, float y, double length, double angleDegree) {
        final Path path = new Path();
        path.moveTo(x, y);
        path.lineTo(
